...
import 'create_property_dealer_model.dart';
export 'create_property_dealer_model.dart';

class CreatePropertyDealerWidget extends StatefulWidget {
  const CreatePropertyDealerWidget({super.key});

  @override
  State<CreatePropertyDealerWidget> createState() =>
      _CreatePropertyDealerWidgetState();
}

class _CreatePropertyDealerWidgetState
    extends State<CreatePropertyDealerWidget> {
  late CreatePropertyDealerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatePropertyDealerModel());
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Company Owner\'s Name*',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Company Owner\'s Mobile Number*',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Company Owner\'s Email ID*',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
