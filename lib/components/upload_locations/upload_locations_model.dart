...
import 'upload_locations_widget.dart' show UploadLocationsWidget;
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class UploadLocationsModel extends FlutterFlowModel<UploadLocationsWidget> {
  ...
  FormFieldController<String>? categoryValueController4;
  // State field(s) for TextField widget.
