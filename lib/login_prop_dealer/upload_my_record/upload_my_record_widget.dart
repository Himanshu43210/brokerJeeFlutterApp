...
import 'upload_my_record_model.dart';
export 'upload_my_record_model.dart';

class UploadMyRecordWidget extends StatefulWidget {
  const UploadMyRecordWidget({super.key});

  @override
  State<UploadMyRecordWidget> createState() => _UploadMyRecordWidgetState();
}

class _UploadMyRecordWidgetState extends State<UploadMyRecordWidget> {
  late UploadMyRecordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadMyRecordModel());
