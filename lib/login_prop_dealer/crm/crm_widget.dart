...
class _CrmWidgetState extends State<CrmWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResulty77 = await BrokerjeeGroup.getUserListCall.call();

      if ((_model.apiResulty77?.succeeded ?? true)) {
        FFAppState().usersName = (getJsonField(
          (_model.apiResulty77?.jsonBody ?? ''),
          r'''$.result[:].name''',
          true,
        ) as List)
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child:
                                                  ...
                                                  controller: _model
                                                          .dealerorCustomerorFinancerValueController ??=
                                                      FormFieldController<
                                                          String>(null),
                                                  options: [
                                                    'Dealer',
                                                  ...
                                                  onChanged: (val) => setState(
                                                      () => _model
                                                              .dealerorCustomerorFinancerValue =
                                                          val),
                                                  width: double.infinity,
                                                  height: 49.0,
                                                  textStyle:
                                              ...
                                              if (_model.categoryValue ==
                                                ...
                                                Padding(
                                                  ...
                                                  child: FlutterFlowDropDown<
                                                      String>(
                                                    controller: _model
                                                            .subCategoryinstiValueController ??=
                                                        FormFieldController<
                                                            String>(null),
                                                    options: [
                                                      'SCHOOL',
