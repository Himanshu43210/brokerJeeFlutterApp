...
import 'my_favourite_new_model.dart';
export 'my_favourite_new_model.dart';

class MyFavouriteNewWidget extends StatefulWidget {
  const MyFavouriteNewWidget({super.key});

  @override
  State<MyFavouriteNewWidget> createState() => _MyFavouriteNewWidgetState();
}

class _MyFavouriteNewWidgetState extends State<MyFavouriteNewWidget> {
  late MyFavouriteNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyFavouriteNewModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: BrokerjeeGroup.myFavLeadsCall.call(),
      builder: (context, snapshot) {
        ...
        final myFavouriteNewMyFavLeadsResponse = snapshot.data!;
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Builder(
                                          builder: (context) {
                                            final favOwnerLead = getJsonField(
                                              myFavouriteNewMyFavLeadsResponse
                                                  .jsonBody,
                                              r'''$.result[:]''',
                                            ).toList();
                                            ...
                                            return FlutterFlowDataTable<
                                              ...
                                              dataRowBuilder: (favOwnerLeadItem,
                                                      favOwnerLeadIndex,
                                                      selected,
                                                      onSelectChanged) =>
                                                  DataRow(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Builder(
                                        builder: (context) {
                                          final favDealerLead = getJsonField(
                                            myFavouriteNewMyFavLeadsResponse
                                                .jsonBody,
                                            r'''$.result[:]''',
                                          ).toList();
                                          ...
                                          return FlutterFlowDataTable<dynamic>(
                                            ...
                                            dataRowBuilder: (favDealerLeadItem,
                                                    favDealerLeadIndex,
                                                    selected,
                                                    onSelectChanged) =>
                                                DataRow(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return FlutterFlowDataTable<
                                                dynamic>(
                                              controller: _model
                                                  .paginatedDataTableController11,
                                              data: favOwnerLead,
                                              columnsBuilder: (onSortChanged) =>
                                                  [
                                                DataColumn2(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return FlutterFlowDataTable<
                                                dynamic>(
                                              controller: _model
                                                  .paginatedDataTableController12,
                                              data: favOwnerLead,
                                              columnsBuilder: (onSortChanged) =>
                                                  [
                                                DataColumn2(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return FlutterFlowDataTable<
                                                dynamic>(
                                              controller: _model
                                                  .paginatedDataTableController13,
                                              data: favOwnerLead,
                                              columnsBuilder: (onSortChanged) =>
                                                  [
                                                DataColumn2(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return FlutterFlowDataTable<
                                                dynamic>(
                                              controller: _model
                                                  .paginatedDataTableController14,
                                              data: favOwnerLead,
                                              columnsBuilder: (onSortChanged) =>
                                                  [
                                                DataColumn2(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return FlutterFlowDataTable<
                                                dynamic>(
                                              controller: _model
                                                  .paginatedDataTableController15,
                                              data: favOwnerLead,
                                              columnsBuilder: (onSortChanged) =>
                                                  [
                                                DataColumn2(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return FlutterFlowDataTable<
                                                dynamic>(
                                              controller: _model
                                                  .paginatedDataTableController16,
                                              data: favOwnerLead,
                                              columnsBuilder: (onSortChanged) =>
                                                  [
                                                DataColumn2(
